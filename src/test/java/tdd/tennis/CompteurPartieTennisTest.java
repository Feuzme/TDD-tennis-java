...
class CompteurPartieTennisTest {
	...
	@Test
	@DisplayName("Quand joueur1 gagne un point, il passe de 0 à 15")
	...
	@Test
	@DisplayName("Quand joueur2 gagne un point, il passe de 0 à 15")
	...
	@Test
	@DisplayName("Quand un joueur1 gagne un point, il passe de 15 à 30")
	...
	@Test
	@DisplayName("Quand un joueur2 gagne un point, il passe de 15 à 30")
	...
	@Test
	@DisplayName("Quand un joueur1 gagne un point, il passe de 30 à 40.")
	...
	@Test
	@DisplayName("Quand un joueur2 gagne un point, il passe de 30 à 40.")
